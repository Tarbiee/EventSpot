                ...
                <Row style={{ display: 'flex', flexWrap: 'wrap' }}>
                    {events.map((event) => (
                        <Col key={event.event_id} xs={6} sm={6} md={3} lg={3}>
                            <Card style={{ marginBottom: '1rem', height: 'auto', overflow: "hidden", borderRadius: "30px" }}>
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text style={{ fontSize: "15px" }}>Description: {event.event_description}</Card.Text>
                                    <Link to={`/events_card/${event.event_id}`}>
                                        <Button variant="primary" style={brownButtonStyle}>
                                            More Info
                                        </Button>
                                    </Link>
                                </Card.Body>
